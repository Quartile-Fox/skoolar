      ...
      >
          ...
          <div className="flex space-x-2 ml-4">
            <Link href="/login">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 text-base bg-[#2B478B] text-white rounded-md hover:bg-[#1E3A8A]"
              >
                Login
              </motion.button>
            </Link>
        ...
        <main className="flex-grow">
          <section className="container mx-auto px-4 py-12 flex items-center">
            <div className="w-full md:w-1/2 pr-0 md:pr-8">
              <motion.h1
                ...
                className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#2B478B] mb-2 md:mb-4"
              >
                Educate Today,
                <br />
                Innovate Tomorrow
              ...
              <motion.p
                ...
                className="text-gray-600 mb-4 md:mb-6 max-w-md text-sm md:text-base"
              >
                "We provide the best facilities for your child's education,
                preparing them for success, with the skills for a bright
                future."
              </motion.p>
              <motion.div
                initial={{ y: 50, opacity: 0 }}
              ...
              >
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 bg-[#2B478B] text-white rounded-md hover:bg-[#1E3A8A] text-sm md:text-base"
                >
                  Start
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="px-4 py-2 border border-[#2B478B] text-[#2B478B] rounded-md hover:bg-gray-100 flex items-center text-sm md:text-base"
                >
                  Find More
                  <svg
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        activities and assignments, allowing them to contribute
                        to their child's education effectively.
                      </p>
                    </div>
                  </motion.div>
                  <motion.div
          ...
          <motion.section
            ...
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
            className="bg-[#2B478B] py-16 text-white"
          >
            <div className="container mx-auto px-4 text-center">
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-3 bg-white text-[#2B478B] rounded-md hover:bg-gray-100 text-lg font-semibold"
              >
                Enroll Now
              </motion.button>
            </div>
